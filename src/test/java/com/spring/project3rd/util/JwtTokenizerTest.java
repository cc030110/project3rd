...
public class JwtTokenizerTest {
    ...
    public void createToken() throws Exception{ // JWT 토큰을 생성.
        ...
        // application.prosperties 파일의 jwt: secretKey: 값
    ...
    public void parseToken() throws Exception{
        byte[] accessSecret = this.accessSecret.getBytes(StandardCharsets.UTF_8);
        String jwtToken = "eyJhbGciOiJIUzI1NiJ9.eyJzdWIiOiJ1cnN0b3J5QGdtYWlsLmNvbSIsInJvbGVzIjpbIlJPTEVfVVNFUiJdLCJ1c2VySWQiOjEsImlhdCI6MTY5MTk4MjU0NiwiZXhwIjoxNjkxOTg0MzQ2fQ.A0ikDnvhFeuMPpPswyWdeAoGHKMQ7DYRpt629HfM_PI";
