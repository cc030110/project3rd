...
public interface BoardFreeRepository extends JpaRepository<BoardFree,Integer> {
    ...
    // 게시판 전체 목록 (제목 검색)
    List<BoardFree> findByTitleContaining(String keyword, Pageable pageable);
    ...
    Page<BoardFree> findByIdContainingAndIdNotIn(String id, List<String> excludedIds, Pageable page);
