        ...
        <div class="main">
            ...
            <div class="intro_con">
                ...
                <div class="intro_explan">
                    <p><spring:message code="index.explan_1"/></p><br>
                    <p><spring:message code="index.explan_2"/></p><br>
                    <p><spring:message code="index.explan_3"/></p><br>
                    <p><spring:message code="index.explan_4"/></p><br>
